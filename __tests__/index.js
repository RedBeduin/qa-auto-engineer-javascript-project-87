...
const pathJsonFirst = './__fixtures__/ordinary_test_1.json'
const pathJsonSecond = './__fixtures__/ordinary_test_2.json'
const yamlFirst = './__fixtures__/yaml_test_1.yml'
const yamlSecond = './__fixtures__/yaml_test_2.yml'
const pathResult = './__fixtures__/raw_result.txt'
const pathResultPlain = './__fixtures__/plain_result.txt'
const pathResultJson = './__fixtures__/json_result.txt'
